...
print "%r is %r inches tall or %r centimeters tall." % (name, height, height_in_centimeters)
print "%r weighs %r pounds or %r kilograms." % (name, weight, weight_in_kilograms)


# Study Drills
# ------------
# 1. Changed all variables that started with my_ by using search and replace
# 2. Added lines 20-24 which convert inches to centimeters and pounds to kilograms
...
# 4. Modified lines 23 and 24 substituting %s and %r - noteably, %d throws an error because 
# the variables are all strings, not integers.
